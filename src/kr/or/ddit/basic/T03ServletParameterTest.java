...
public class T03ServletParameterTest extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
	 	 ...
	 	 - getParameterNames() : 요청메시지에 존재하는 모든 파라미터 이름을 가져올때 사용함.
		*/
		
		// POST 방식으로 넘어오는 Body데이터를 가져올 때 적절한 인코딩 처리를 해야 한다.
...
//		resp.setContentType("type/html"); ///이렇게 모르는 타입일 경우  download가 된다
//		resp.setContentType("text/plain"); ///형식이 달라진다
